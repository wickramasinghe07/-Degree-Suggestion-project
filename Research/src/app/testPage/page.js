                        ...
                        <div class="col-lg-12 col-12">
                            <form class="custom-form hero-form" onSubmit={handleSubmit}>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div className="pb-1 ">
                                            <button type="button" onClick={handelAssistInterest} className="p-1 bg-white rounded-xl text-xs">Need Assist</button>
                                        </div>
                                        {
                                            show_Interest_field ?
                                                <div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div className="pb-1 ">
                                            <button type="button" onClick={handeCourseButton} className="p-1 bg-white rounded-xl text-xs">Need Assist</button>
                                        </div>
                                        {
                                            show_Course_field ?
                                                <div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div className="pb-1 ">
                                            <button type="button" onClick={handelAssistValue} className="p-1 bg-white rounded-xl text-xs">Need Assist</button>
                                        </div>
                                        {
                                            courseValResData != "" ?
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div className="pb-1 ">
                                            <button type="button" onClick={handelAssistSkill} className="p-1 bg-white rounded-xl text-xs">Need Assist</button>
                                        </div>
                                        {
                                            courseSkillResData != "" ?
